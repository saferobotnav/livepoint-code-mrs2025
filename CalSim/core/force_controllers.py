...
class QRotorGeometricPD(Controller):
    def __init__(self, observer, lyapunovBarrierList, trajectory, depthCam, delta):
        """
        ...
        self.trackingController = QRotorCBFQPR2(self.observer, lyapunovBarrierList, self.trajectory, depthCam, delta)
    ...
    def eval_moment(self, t):
        ...
        return -self.KR * eR - self.Komega * eOmega + hat(omega) @ self.I @ omega
