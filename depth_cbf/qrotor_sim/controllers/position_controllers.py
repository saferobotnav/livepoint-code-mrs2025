...
class QRotorCBFQPR2(CBF_QP_R2_3D_Ctrl):
    ...
    def __init__(self, observer, lyapunovBarrierList, trajectory, depthCam, m = None, g = None):
        ...
        Args:
            ...
            trackingController (Controller): controller object that outputs a 3D force vector
        """ 
        print("QRotorCBFQPR2.init called in position_controller.py")

        #print("this is in position_controllers.py. DO WE GET TO QROTORCBFQPR2?")
        #store CBF parameters
        ...
        if isinstance(observer.dynamics, cs.PlanarQrotor):
            ...
            print("Next we create PointcloudQrotor3D object in position_controllers.py")
    ...
    def eval_lqr_input(self, t):
        ...
        """
        print("QRotorCBFQPR2.eval_lqr_input called in position_controller.py")

        #print("do we get to eval_lqr_input in position_controllers.py?")
    ...
    def LH(self, q, qDot, A, b, c):
        ...
        Returns:
            Lfh, Lgh, Lf^2h, LgLfh: approximations of the lie derivatives
        """
        print("QRotorCBFQPR2.LH called in position_controller.py")
